...
def QuaternionRotation(angle):
    ...
    while True:
        ...
        ax.add_collection3d(art3d.Poly3DCollection([poly3], color='blue', alpha=0.8))
        poly4 = list(zip(x2[3:7],y2[3:7],z2[3:7]))
        ax.add_collection3d(art3d.Poly3DCollection([poly4], color='midnightblue', alpha=0.8))
...
angle = [60.0, 10.0, 30.0]       # 最終姿勢のオイラー角
